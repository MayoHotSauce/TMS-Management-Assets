...
<div class="card">
    ...
    <div class="card-body">
        <div class="row mb-4">
            <div class="col-md-6">
                @php
                    \Log::info('Stock Check Creator:', ['creator' => $stockCheck->creator]);
                    \Log::info('Creator Member:', ['member' => $stockCheck->creator?->member]);
                @endphp
                <p><strong>Created By:</strong> {{ $stockCheck->creator->nama ?? 'N/A' }}</p>
